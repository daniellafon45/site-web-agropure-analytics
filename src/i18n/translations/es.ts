...
export const es: Translations = {
  ...
  home: {
      ...
      items: [
        {
          id: "gouvernement",
          cardTitle: "Gobiernos",
          desc: "¿Los datos agrícolas nacionales siguen dispersos y las encuestas de campo tardan meses en consolidarse? Una plataforma nacional de datos agrícolas centraliza parcelas, cultivos y recursos hídricos para orientar las políticas públicas agrícolas con una visión fiable y actualizada.",
        },
        {
          id: "agriculteur",
          cardTitle: "Agricultores",
          desc: "¿Decide demasiado tarde por falta de datos claros a nivel de parcela? Aplicaciones de apoyo a la decisión agrícola, diagnósticos fotográficos y calculadoras simples protegen sus cultivos, reducen costes y optimizan rendimientos, sin experiencia técnica.",
        },
        {
          id: "cooperative",
          cardTitle: "Cooperativas y ONG",
          desc: "¿Sus filieras carecen de visibilidad en mercados, flujos y trazabilidad agrícola? Herramientas de comercialización, seguimiento de trashumancia y trazabilidad integral para asegurar ingresos de productores y reforzar la resiliencia de las cadenas de valor.",
        },
        {
          id: "assurance",
          cardTitle: "Seguros",
          desc: "¿Evaluar el riesgo agrícola sin datos de campo fiables expone a suscripciones o indemnizaciones imprecisas? Indicadores espacializados e históricos, actualizados en continuo, miden el rendimiento de las explotaciones y aseguran cada decisión de suscripción.",
        },
      ],
    },
    integrations: {
    ...
    faq: {
      ...
      subtitle:
        "Respuestas claras sobre monitoreo nacional de cultivos, diagnóstico en campo, scoring crediticio y despliegue, para equipos en África, Canadá y Estados Unidos.",
