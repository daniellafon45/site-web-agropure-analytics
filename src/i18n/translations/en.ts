      ...
      items: [
        {
          ...
          desc: "National farm data stays scattered and field surveys take months to consolidate? A national agricultural data platform centralizes plots, crops and water resources so you can steer agricultural public policy with a reliable, real-time national view.",
        },
        {
          id: "agriculteur",
          cardTitle: "Farmers",
          desc: "Deciding too late because plot-level data is unclear? Farm decision-support apps, photo diagnostics and simple calculators help you protect crops, cut costs and optimize yields, no data expertise required.",
        },
        {
          id: "cooperative",
          cardTitle: "Cooperatives & NGOs",
          desc: "Supply chains lack visibility on markets, flows and agricultural traceability? Market tools, transhumance tracking and end-to-end traceability to secure producer income and strengthen agricultural value-chain resilience.",
        },
        {
          id: "assurance",
          cardTitle: "Insurance",
          desc: "Assessing agricultural risk without reliable field data leads to inaccurate underwriting and claims? Continuously updated spatial indicators and historical data measure farm performance and secure every underwriting decision.",
        },
      ],
    },
    integrations: {
