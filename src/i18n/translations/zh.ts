...
export const zh: Translations = {
  ...
  home: {
      ...
      items: [
        {
          id: "gouvernement",
          cardTitle: "政府",
          desc: "全国农业数据分散、田间调查数月才能汇总？国家农业数据平台统一地块、作物与水资源，以可靠、实时的全国视图支撑农业公共政策决策。",
        },
        {
          id: "agriculteur",
          cardTitle: "农户",
          desc: "因缺乏清晰的地块级数据而决策滞后？农业决策支持应用、照片诊断与简易计算器帮助保护作物、降低成本、优化产量，无需专业技术背景。",
        },
        {
          id: "cooperative",
          cardTitle: "合作社与非政府组织",
          desc: "产业链在市场、流向与农业溯源上缺乏可见性？市场工具、转场追踪与端到端溯源，保障生产者收入并增强农业价值链韧性。",
        },
        {
          id: "assurance",
          cardTitle: "保险",
          desc: "缺乏可靠田间数据如何准确评估农业风险？持续更新的空间化指标与历史数据衡量农场绩效，为每笔承保决策提供依据。",
        },
      ],
    },
    integrations: {
    ...
    faq: {
      title: "常见问题解答",
      subtitle:
        "关于全国作物监测、田间诊断、信贷评分与部署的清晰解答, 面向非洲、加拿大和美国的团队。",
