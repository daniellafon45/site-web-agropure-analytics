      ...
      items: [
        {
          ...
          desc: "Données éparpillées, rapports terrain livrés avec des mois de retard : vous pilotez à l'aveugle. AgroPure unifie parcelles, cultures et ressources hydriques sur un tableau de bord national, pour agir au bon moment, pas après la saison.",
        },
        {
          id: "agriculteur",
          cardTitle: "Agriculteurs",
          desc: "Sans données claires à la parcelle, chaque jour compte contre vous. Diagnostics photo, alertes et recommandations simples : protégez vos cultures, réduisez vos intrants et décidez avant que le risque ne s'aggrave.",
        },
        {
          id: "cooperative",
          cardTitle: "Coopératives & ONG",
          desc: "Marchés, flux et traçabilité invisibles : les revenus producteurs en pâtissent. Mise en marché, suivi de transhumance et traçabilité bout en bout pour sécuriser vos filières et renforcer la confiance de vos partenaires.",
        },
        {
          id: "assurance",
          cardTitle: "Assurances",
          desc: "Souscrire sans données terrain fiables, c'est tarifer et indemniser au mieux. AgroPure actualise en continu les indicateurs par exploitation — pour réduire les erreurs, limiter la fraude et accélérer chaque décision.",
        },
      ],
    },
    integrations: {
