/** ISO 3166-1 alpha-2 + ITU E.164 calling codes (all sovereign states and common territories). */
export const PHONE_COUNTRY_DATA: { iso2: string; name: string; dialCode: string }[] = [
